...
function PartnerBidsList({ navigation, currentState }) {
  const boardList = [
    {
          ...
          <TouchableHighlight style = {[globalStyles.br16, globalStyles.h163]}
            ...
            <View style = {[globalStyles.h163, globalStyles.pr16, globalStyles.pl16, globalStyles.pt13]}>
              <View style = {globalStyles.rowFlexShow}>
                ...
                <View style = {[globalStyles.mt_5, globalStyles.w52, globalStyles.h26, globalStyles.br4, globalStyles.algCtr, globalStyles.justCtr, {backgroundColor: '#D7F7F9'}]}>
                  <Text style = {[globalStyles.fontMont, globalStyles.fs12, globalStyles.lh18, globalStyles.lSpace4, globalStyles.fw400, {color: '#1B7176'}]}>{item.state ? 'Open' : 'Close'}</Text>
                </View>
              </View>
