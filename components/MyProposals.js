          ...
          <TouchableHighlight style = {[globalStyles.br16, globalStyles.h163]}
            ...
            <View style = {[globalStyles.h163, globalStyles.pr16, globalStyles.pl16, globalStyles.pt13]}>
              <View style = {globalStyles.rowFlexShow}>
                <Text style = {[globalStyles.fontMont, globalStyles.fs12, globalStyles.lh18, globalStyles.lSpace4, globalStyles.fw400, globalStyles.flex1, {color: 'rgba(0, 0, 0, 0.38)'}]}>{item.sent}</Text>
                <View style = {[globalStyles.mt_5, globalStyles.w80, globalStyles.h26, globalStyles.br4, globalStyles.algCtr, globalStyles.justCtr, {backgroundColor: '#C7DAF9'}]}>
                  <Text style = {[globalStyles.fontMont, globalStyles.fs12, globalStyles.lh18, globalStyles.lSpace4, globalStyles.fw400, {color: '#003EB5'}]}>Proposed</Text>
                </View>
              </View>
