...
function BidDetails({ navigation, route }) {
      ...
      <View style = {[globalStyles.rowFlexShow, globalStyles.pt18, globalStyles.algStart]}>
        <View style = {globalStyles.h30}>
          <TouchableHighlight
            ...
            activeOpacity = {0.6}
            underlayColor = '#ccc'
            onPress={() => navigation.navigate('bid_boards')}>
            <Image 
        ...
        >Bid Details</Text>
        <View style = {[globalStyles.w50, globalStyles.h24, globalStyles.mt1, globalStyles.ml10, globalStyles.algCtr, globalStyles.justCtr, globalStyles.br4, {backgroundColor: '#C4F1D2'}]}>
          <Text
            style = {[globalStyles.fontMont, globalStyles.fs12, globalStyles.fw400, globalStyles.lSpace4, globalStyles.lh18, {color: '#00B53A'}]}
          >{route.params.state == 1 ? 'Open' : 'Close'}</Text>
        </View>
      </View>
