...
function ScheduleAppointment({ navigation, route }) {
      ...
      <View style = {[globalStyles.fWidth, globalStyles.mt15]}>
        ...
        <View style = {[globalStyles.ml20, globalStyles.mr20, globalStyles.mt_10]}>
          <TextInput
            ...
            placeholderTextColor={'rgba(0, 0, 0, 0.87)'}
            style = {[globalStyles.bw1, globalStyles.br4, globalStyles.pl16, globalStyles.fs14, globalStyles.lh24, globalStyles.fontMont, globalStyles.pt13, globalStyles.lSpace5, {borderColor: locationFocused ? '#EFB057' : 'black', color: 'rgba(0, 0, 0, 0.87)'}]}></TextInput>
        </View>
        <View style = {[globalStyles.ml20, globalStyles.mr20, globalStyles.mt10]}>
          ...
          <TextInput
            ...
            style = {[globalStyles.bw1, globalStyles.br4, globalStyles.pl16, globalStyles.fs14, globalStyles.lh24, globalStyles.fontMont, globalStyles.lSpace5, {textAlignVertical: 'top', borderColor: noteFocused ? '#EFB057' : 'black', color: 'rgba(0, 0, 0, 0.6)'}]}></TextInput>
        </View>
      </View>
        ...
        <View style = {[globalStyles.h40, globalStyles.br24, globalStyles.bw1, globalStyles.justCtr, {borderColor: '#EFB057', backgroundColor: '#EFB057'}]}>
          <TouchableHighlight style = {globalStyles.br24}
            ...
            <View style = {[globalStyles.fWidth, globalStyles.h40]}>
              <Text style = {[globalStyles.colorWhite, globalStyles.fontMont, globalStyles.fw500, globalStyles.fs16, globalStyles.lh24, globalStyles.lSpace125, globalStyles.tCenter, globalStyles.br24, globalStyles.vMid, globalStyles.mt6]}>Schedule</Text>
            </View>
          </TouchableHighlight>
        </View>
