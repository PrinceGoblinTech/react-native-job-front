...
function MsgDetail({ navigation, route }) {
  const msgList = [
    {
      date: '27 Jun 2023',
      user: '',
      ...
      <View style = {[globalStyles.rowFlexShow, globalStyles.pt18, globalStyles.algStart]}>
        <View style = {globalStyles.h30}>
          <TouchableHighlight
            ...
            activeOpacity = {0.6}
            underlayColor = '#ccc'
            onPress={() => navigation.navigate('owner_msg')}>
            <Image 
        ...
        >Christin Arc</Text>
        <Text
          style = {[globalStyles.fontMont, globalStyles.br4, globalStyles.fs12, globalStyles.fw400, globalStyles.lSpace4, globalStyles.lh16, globalStyles.mt1, globalStyles.ml5, globalStyles.p4, {backgroundColor: (route.params.mode) ? 'rgba(0, 181, 58, 0.12)' : '#DEEEF8', color: (route.params.mode) ? '#00B53A' : '#0074B5'}]}
        >{route.params.mode ? "Internal" : "Customer"}</Text>
      ...
      <View style = {[globalStyles.rowFlexShow, globalStyles.algStart, globalStyles.h40]}>
        ...
        <View style = {[globalStyles.flex1, globalStyles.h40]}>
          <Input 
            ...
            style = {[globalStyles.fontMont, globalStyles.fs14, globalStyles.lSpace5, globalStyles.h40, globalStyles.mt_10, globalStyles.pb0, globalStyles.bw1, globalStyles.pl14, globalStyles.br10, {borderBottomWidth: 1, borderColor: '#DCDCDD'}]}/>
        </View>
        <Image 
          style = {[globalStyles.resizeContain, globalStyles.h18, globalStyles.mr15, globalStyles.mt3]}
